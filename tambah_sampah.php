            ...
            <div class="card--container">
                ...
                <form method="POST" action="">
                    <div class="container">
                        ...
                        <input type="text" id="harga_pengepul" placeholder="Masukkan Harga Pengepul" name="harga_pengepul" required><br><br>
                        ...
                        <input type="text" id="harga_nasabah" placeholder="Harga Nasabah" name="harga_nasabah" readonly><br><br>
