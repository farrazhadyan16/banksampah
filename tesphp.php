        ...
        <div class="card--container">
            ...
            <form method="POST" action="">
                <div class="container">
                    ...
                    <!-- <input type="text" placeholder="Masukkan ID Project yang akan dimonitoring" name="id"><br><br> -->

                    <div class="dropdown-container">
                        <!-- Dropdown Button -->
                        <div class="dropdown-button">Pilih ID Monitoring</div>
                        <!-- Dropdown Content -->
                        <div class="dropdown-content" id="dropdownContent">

                            <?php
                        // Ambil data ID Monitoring dari tabel data_monitoring
                        $conn = mysqli_connect("localhost", "root", "", "db_pm_old"); // Ganti dengan detail koneksi Anda
