...
<head>
    ...
    <title>Bank Sampah | Edit Nasabah</title>
        ...
        <div class="card--container">
            ...
            <form method="POST" action="">
                <div class="container">
                    ...
                    <label for="">#</label><br>
                    <input type="text" placeholder="Masukkan ID Project" name="id" value="<?= $user["id"] ?>"><br><br>
                    ...
                    <input type="text" placeholder="Masukan Tgl JO" name="nama" value="<?= $user["nama"] ?>"><br><br>
                    ...
                    <input type="text" placeholder="Masukkan Kode GBJ" name="nik" value="<?= $user["nik"] ?>"><br><br>
