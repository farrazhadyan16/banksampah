...
<head>
    ...
    <title>PMElectric | Checker</title>
        ...
        <div class="card--container">
            ...
            <form method="POST" action="">
                <div class="container">
                    ...
                    <input type="hidden" name="page" value="checker">
                    ...
                    <input type="text" placeholder="Masukkan PIC" name="checker_pic"><br><br>

                    <label for="">Start</label><br>
                    <input type="date" placeholder="Masukan Waktu Start" name="checker_start"><br><br>

                    <label for="">END</label><br>
                    <input type="date" placeholder="Masukan Waktu End" name="checker_end"><br><br>
